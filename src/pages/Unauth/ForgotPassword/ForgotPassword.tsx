...
const ForgotPassword = () => {
  ...
  const onFinish = async (values: any) => {
    try {
      ...
      Swal.fire({
        title: "Email sent !",
        text: `An email with a recover password link will be sent to ${email}, relax !`,
        icon: "success",
      ...
      <DesktopBreakPoint>
        ...
        <Wrapper backgroundImage={backgroundImage}>
          ...
          <Content>
            ...
            <FormSection>
              <Divider>Recover your password !</Divider>
              <FormContainer>
                <LoginMessage >Send recover password email !</LoginMessage>
                <Form
                  autoComplete="off"
                  onFinish={onFinish}
